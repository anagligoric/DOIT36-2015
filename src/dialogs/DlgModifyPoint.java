...
public class DlgModifyPoint extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public DlgModifyPoint(Point pt) {
		point = new Point(pt.getX(), pt.getY(), pt.getClrBorderColor());
		chosenColor = pt.getClrBorderColor();
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
							...
							try {
								if (rdbtnMoveTo.isSelected()) {
									point.moveTo(Integer.parseInt(txtX.getText()), Integer.parseInt(txtY.getText()));
								}
								if (rdbtnMoveBy.isSelected()) {
									point.moveBy(Integer.parseInt(txtByX.getText()),
											Integer.parseInt(txtByY.getText()));
								}
								point.setClrBorderColor(btnColor.getSelectedColor());
								setVisible(false);
			...
			txtX.setText(Integer.toString(pt.getX()));
			txtY.setText(Integer.toString(pt.getY()));
		}
	}
